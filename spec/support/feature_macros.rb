module FeatureMacros
  ...
  def edit_question_and_check_valid(question, container, new_attributes)
    ...
    within(container) do
      ...
      expect(page).to have_link "edit_q#{question.id}"
  ...
  def edit_question_and_check_blank(question, container)
    click_on "edit_q#{question.id}"
